...
internal partial class UserService
{
    ...
    public async Task<List<UserRoleDto>> GetRolesAsyncByUserName(string userName, CancellationToken cancellationToken)
    {
        var userRoles = new List<UserRoleDto>();
    ...
    public async Task<string> AssignRolesAsyncByUserName(string userName, UserRolesRequest request, CancellationToken cancellationToken)
    {
        ArgumentNullException.ThrowIfNull(request, nameof(request));

        var user = await _userManager.Users.Where(u => u.UserName == userName).FirstOrDefaultAsync(cancellationToken);
