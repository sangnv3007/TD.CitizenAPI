...
public class Company : AuditableEntity, IAggregateRoot
{
    ...
    public Company(string name, string? code, string? icon, int? seatCount, string? description)
    {
        Name = name;
        Code = code;
        Icon = icon;
    ...
    public Company Update(string? name, string? code, string? icon, int? seatCount, string? description)
    {
