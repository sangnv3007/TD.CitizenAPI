...
//Thong tin seagame
public class SeaGame : AuditableEntity, IAggregateRoot
{
    ...
    public SeaGame(string title, string? actor, string? content, DateTime? date, string? image, string? source, int? viewQuantity)
    {
        Title = title;
        Actor = actor;
        Content = content;
    ...
    public SeaGame Update(string? title, string? actor, string? content, DateTime? date, string? image, string? source, int? viewQuantity)
    {
