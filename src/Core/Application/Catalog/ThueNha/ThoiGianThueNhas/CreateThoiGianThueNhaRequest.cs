...
public class CreateMucGiaThueNhaRequestValidator : CustomValidator<CreateThoiGianThueNhaRequest>
{
...
public class CreateMucGiaThueNhaRequestHandler : IRequestHandler<CreateThoiGianThueNhaRequest, Result<Guid>>
{
