...
public class UpdateMucGiaThueNhaRequestValidator : CustomValidator<UpdateThoiGianThueNhaRequest>
{
...
public class UpdateMucGiaThueNhaRequestHandler : IRequestHandler<UpdateThoiGianThueNhaRequest, Result<Guid>>
{
