...
public class GetProductViaDapperRequest : IRequest<CategoriesInProduct>
{
...
public class GetProductViaDapperRequestHandler : IRequestHandler<GetProductViaDapperRequest, CategoriesInProduct>
{
    ...
    public async Task<CategoriesInProduct> Handle(GetProductViaDapperRequest request, CancellationToken cancellationToken)
    {
        ...
        return product.Adapt<CategoriesInProduct>();
    }
}